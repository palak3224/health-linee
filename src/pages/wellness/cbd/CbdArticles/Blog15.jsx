...
export default function CbdArticle15() {
          ...
          <div className="lg:col-span-1 lg:sticky lg:top-28 lg:self-start">
            ...
            <div className="bg-white rounded-lg p-6 mb-8 border border-gray-200 shadow-sm">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="text-sm font-medium text-gray-800">CBD Brand Comparison Tool</h4>
                    <a href="#" className="text-xs text-blue-600 hover:underline">Download Excel</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-100 rounded-lg p-6 mb-8">
              ...
              <div className="bg-green-600 rounded-lg p-6 text-white text-center">
                <h4 className="font-bold mb-2">CBD Quality Guide</h4>
                <p className="text-sm mb-4">
                  Get our comprehensive 50-page guide to identifying premium CBD products
                </p>
